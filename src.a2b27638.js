...
var audioHit = newAudio('../assets/smash.mp3');
var song = newAudio('../assets/audio.mp3');
var timeoutId;
var timer;
var time = 30;
var lastHole = 0;
...
function whack() {
  ...
  setTimeout(function () {
    _this.classList.remove('whacked');
  }, 1000);
}
...
/**
 * This function updates the timer by decrementing the time variable
 * by 1. It also updates the timerDisplay by setting the textContent
 * to the time variable. The function returns the time variable.
 * @returns {number} time
 */
